...
if "%suffix%"==".mp3" goto install_apk
...
rem =========================
set tempath=%TEMP%\installResult
adb install -r %installFile% > %tempath%
type %tempath%
findstr /Q "Failure" tempath
del %tempath%
rem =========================
rem install failed
...
:copy_music
push %installFile% /sdcard/ttpod/song/
goto end
